    ...
    <div className="px-[0.25em] md:px-[.47em] py-[0.25em] md:pl-[0.7em] md:pr-[0.25em] text-hero-xs sm:text-hero-sm md:text-hero-md lg:text-hero-lg bg-neutralsilver">
      ...
      <div className="relative bg-neutralsilver   ">
        ...
        <video
          controls
          autoPlay={true}
          className="w-full h-auto relative z-20 max-w-[955px] max-h-[700px]"
        >
        ...
        >
          <div className="w-full flex justify-end">
            <p
              className="text-blackgray font-[700] font-urbanist
                        text-[1em]
                        zulo:text-[0.9em]
                        sm:text-[0.9em]
                        md:text-[0.86em]
          ...
          <div className="flex flex-col gap-[0.2em]">
            <div className="flex gap-[0.2em] items-end">
              ...
              <p className="font-sans font-[700] text-[0.3em] lg:text-[0.4em] font-blackgray ">
                TM
              </p>
            </div>
            <p
              className="font-urbanist font-[800] 
                        text-[0.8em]
                        zulo:text-[0.65em]
                        md:text-[0.6em]
                        lg:text-[0.81em]
          ...
          <div className="mt-[0.55em]">
            <p
              className="font-urbanist font-[800] 
                        ...
                        md:text-[0.7em]
                        lg:text-[0.70em] 
                        woodo:text-[0.75em] text-blackgray italic"
            >
          ...
          >
            ...
            <div className="w-full flex flex-col items-end gap-[12px] sm:gap-[15px] md:gap-[17.5px] woodo:gap-[15px] mt-[24px] sm:mt-[30px] md:mt-[35px] woodo:mt-[0px]">
              <div className="w-full woodo:w-[65%] flex  justify-self-end gap-[0.8em] items-start justify-start">
                ...
                <FontAwesomeIcon
                  icon={faCircle}
                  className="text-[0.425em] mt-[0.70em] text-black"
                />
                <p className="text-sans font-[500] text-[0.95] lg:text-[0.8em] text-blackgray">
                  Discover how AI (Artificial Intelligence) has transformed how
                  to summarize your LOIs and to{" "}
                  <span className="font-[700]">keep track</span> of your deals
                  in the{" "}
                  <span className="text-primaryyellow font-[600]">
                    {" "}
              ...
              <div className="w-full woodo:w-[65%] flex  justify-self-end gap-[0.8em] items-start justify-start">
                ...
                <p className="text-sans font-[500] text-[0.95] lg:text-[0.8em] text-blackgray">
                  <span className="font-[700]">
                    AbstraPoint™ DealTracker™ (APDT™)
                  </span>{" "}
                  powered by our proprietary AI engine - built by CRE brokers
                  for CRE brokers.
                </p>
              </div>
            </div>
