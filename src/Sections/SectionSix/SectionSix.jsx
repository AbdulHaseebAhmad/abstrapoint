...
export default function SectionSix() {
  return (
    <div className='py-[0.5em] px-[0.25em] text-hero-xs sm:text-hero-sm md:text-hero-md lg:text-hero-lg bg-tint'>{/**layout */}
            ...
            <div className="mx-auto flex flex-col gap-[0.22em] items-center    text-center max-w-[100%] zulo:max-w-[80%] md:max-w-[70%]  lg:max-w-[65%]">
                ...
                <div className=' text-bodyMd-xs sm:text-bodyMd-sm md:text-bodyMd-md lg:text-bodyMd-lg text-center '>
                    <p className='text-[0.7em] sm:text-[0.7em]  font-[400]   font-sans lg:text-[0.7em]  lg:leading-[28px]  font-[400] text-blackgray'>
