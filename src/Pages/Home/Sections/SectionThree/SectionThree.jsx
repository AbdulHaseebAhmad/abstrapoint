...
export default function SectionThree() {
    return (
        <div id="testimonials" name="testimonials" className='px-[.15em] py-[.475em] md:px-[0.50em] lg:px-[0.65em] mb-[3.2em] sm:mb-[1.5em] lg:mb-[1.5em] text-hero-xs sm:text-hero-sm md:text-hero-md lg:text-hero-lg bg-neutralsilver'>
