...
export default function VerticalLine({distance}) {
    return (
        <div className={`bg-neutralsilver absolute h-[98vw] top-[-95vw] woodo:h-[1205px] woodo:top-[-1238px] z-10`}
...
//   lg:h-[1250px] lg:top-[-1300px]
{/**
            <div  top-[-102vw] h-[calc(50px+90vw)] className={`bg-neutralsilver absolute top-[-99px] h-[calc(135px+70vw)] zulo:h-[calc(540px+46vw)] zulo:top-[-365px] sm:h-[calc(90vw)] sm:top-[-125px] md:h-[calc(77vw)] md:top-[-160px]  lg:h-[calc(385px+40vw)] lg:top-[-175px] woodo:h-[calc(138%+4vw)] woodo:top-[-68%] z-10`}
